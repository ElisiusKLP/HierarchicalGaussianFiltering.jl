...
"""
    premade_noisy_categorical_3level(config::Dict; verbose::Bool = true)

The noisy categorical 3 level HGF model takes a vector as input. It has as many binary parents as it has categories.
...
"""
function premade_noisy_categorical_3level(config::Dict; verbose::Bool = true)
    ...
    nodes = [NoisyCategoricalInput("u"), NoisyCategoricalState("xcat")]
