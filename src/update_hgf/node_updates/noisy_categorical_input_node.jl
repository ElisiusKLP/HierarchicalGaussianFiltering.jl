...
"""
function update_node_prediction!(node::NoisyCategoricalInputNode, stepsize::Real)
    return nothing
end
...
"""
function update_node_value_prediction_error!(node::NoisyCategoricalInputNode)
    return nothing
end
...
"""
function update_node_precision_prediction_error!(node::NoisyCategoricalInputNode)
    return nothing
end